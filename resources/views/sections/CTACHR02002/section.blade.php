            ...
            <div class="col-md-12">
                <div class="cta cta-1 cta--horizontal boxed boxed--border text-center-xs e {{ parseSecAttr('.e', $section['classes']) }}">
                    <div class="row justify-content-center p-5">
                        <div class="col-lg-8">
                            <h4>{{ parseContent($section['CTACHR02002_H'],'title') }}</h4>
                        </div>
                        <div class="col-lg-4 text-center">
                            @if(checkContent($section['CTACHR02002_H'], 'link'))
				                <a class="btn btn--primary type--uppercase e {{ parseSecAttr('.e', $section['classes']) }}" href="{{ $section['CTACHR02002_H']['link'] }}">
					                <span class="btn__text">
										{{ parseContent($section['CTACHR02002_H'],'button') }}
									</span> 
								</a>
				            @endif
                        </div>
