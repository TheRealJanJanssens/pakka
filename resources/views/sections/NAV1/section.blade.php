...
-->
                        ...
                        @if(checkLink($section['NAV1_BTN1']['link']) || checkLink($section['NAV1_BTN2']['link']) || checkEditAcces())
                        
	                        <div class="bar__module">
		                        @if(checkLink($section['NAV1_BTN1']['link']) || checkEditAcces())
					                <a class="btn btn--sm type--uppercase e {{ parseSecAttr('.e', $section['classes']) }}" href="{{ $section['NAV1_BTN1']['link'] }}">
						                <span class="btn__text">
											{{ parseContent($section['NAV1_BTN1'],'button') }}
										</span> 
									</a>
					            @endif
					            
					            @if(checkLink($section['NAV1_BTN2']['link']) || checkEditAcces())
					                <a class="btn btn--sm btn--primary type--uppercase e {{ parseSecAttr('.e', $section['classes']) }}" href="{{ $section['NAV1_BTN2']['link'] }}">
						                <span class="btn__text">
											{{ parseContent($section['NAV1_BTN2'],'button') }}
										</span> 
									</a>
					            @endif
	                        </div>
