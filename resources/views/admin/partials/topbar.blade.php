        ...
        <div class="flex items-center justify-start">
          ...
          <a href="{{ "/" }}" class="flex ml-2 md:mr-24">
            @if(isset($settings['app_logo']))
                <img src="{{ config('image.app.public') }}{{ $settings['app_logo'] }}" class="h-10 mr-3" alt="Logo">
            @else
                <img src="{{ config('placeholders.logo') }}" class="h-10 mr-3" alt="Logo">
            @endif
          </a>
            ...
            <div class="flex items-center ml-3">
              <div>
                <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button-2" aria-expanded="false" data-dropdown-toggle="dropdown-2">
                  ...
                  @if(auth()->user()->avatar)
                        <img class="w-8 h-8 rounded-full" src="{{ config('image.avatar.public') }}{{ auth()->user()->avatar }}" alt="user photo">
                    @else
              ...
              <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-2">
                ...
                <ul class="py-1" role="none">
                  ...
                  <li>
                    <a href="{{ route('logout') }}" class="block px-4 py-2 text-sm text-red-700 hover:bg-gray-100 dark:text-red-500 dark:hover:bg-gray-600 dark:hover:text-red-300" role="menuitem">Sign out</a>
                  </li>
                </ul>
              </div>
            </div>
