...
@section('content')
    ...
    <div class="row gap-20 masonry pos-r">
	    ...
	    <div class="masonry-header masonry-item">
		    <div class="row gap-20">
			    <div class='col-md-9'>
				    <h1>Welkom terug {{ auth()->user()->name }}</h1>
				    <p>Er werden <span>36 producten</span> verkocht in de voorbije <span>30 dagen</span></p>
				    
				    <div class="row gap-20">
					    <div class='col-md-6'>
					    	<a href="#">Plaats nieuwe producten online</a>
							<a href="#">Plaats nieuwe producten online</a>
					    </div>
        ...
        <div class="masonry-item w-100">
            <div class="row gap-20">
                ...
                <div class='col-md-3'>
                    <div class="layers bd bgc-white p-20">
                        <div class="layer w-100 mB-10">
                            <p class="lh-1"><i class="margin-icon status-icon status-icon-green"></i>Online producten</p>
                        </div>
                ...
                <div class='col-md-3'>
                    <div class="layers bd bgc-white p-20">
                        <div class="layer w-100 mB-10">
                            <p class="lh-1"><i class="margin-icon status-icon status-icon-red"></i>Offline producten</p>
                        </div>
                        <div class="masonry-result layer w-100">
                            <h5>255</h5>
                        </div>
